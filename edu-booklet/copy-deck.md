...
> **Status: transcribed from the build.** `edu-booklet/index.html` is the source of truth for this piece.
> This deck was regenerated from it after the distill and typeset passes and matches it verbatim.
> If the two ever disagree, the build wins — re-transcribe rather than editing the build to match the deck.

## Locked facts used throughout (do not vary)

| Fact | Booklet wording |
|---|---|
...
| Delivery (both) | **Fully online. No Toronto visits required.** |
| Study mode (both) | **Part-time only**, one course per term |
...
## Print discipline applied

**Page budget, not just block budget.** Headlines ≤ 8 words. Body blocks ≤ 50 words. **And no page exceeds ~165 words** — this is the constraint the first draft lacked, which is how seven individually-compliant blocks stacked into a 267-word page. Current totals:
...
Left page of spread 2–3. Mission block above, four pillars in a 2×2 grid, photo band below.
...
**SUBHEAD** (7 words)
> Where Faith, Wisdom, and Educational Practice Intersect

**BODY** (23 words)
> ICS courses invite Christian educators out of the daily rush and into a community that thinks deeply about practice and why it matters.

## Four pillars — micro-head + one line each

1. **Biblically Rooted** (12 words)
   > Grounded in the Reformational tradition, centred on the love embodied by Christ.
2. **Designed for Working Educators** (8 words)
...
# P3 — Built Around Your School Year

One idea: **the logistics objection, killed.** Free space is distributed evenly between the four blocks.

**EYEBROW**
> Time · Money · Fit

**HEADLINE** (5 words)
> Built Around Your *School Year*

**BODY** (20 words)
> Courses follow the rhythms of a teaching year, so you can pursue graduate study without stepping away from the classroom.

## Fact panel — label + value, 7 rows

| Label | Value |
|---|---|
| Delivery | Fully online. No Toronto visits required. |
| Format | Part-time only · one course per term |
| Class time | Asynchronous · ~6 live Zoom sessions per course |
| Cohort size | Up to 12 students |
...
> Kevin Otter — Teacher since 2009, Northumberland Christian School · MA-EL student
...
# P4–P5 — Centre spread: the two programs, face to face

Mirrored layouts. Identical slots, identical order, so comparison happens across the gutter without vertical eye movement. P5 carries a hidden eyebrow to hold the band slot open at the same height as P4.

## Slot A — EYEBROW
- **P4:** Master of Worldview Studies in Education
- **P5:** Master of Arts (Philosophy) in Educational Leadership

## Slot B — PROGRAM MARK
- **P4:** MWS-E · **P5:** MA-EL

## Slot C — HEADLINE
- **P4** (6 words): Develop Your Practice, Enhance Your *Career*
- **P5** (4 words): Contribute to the *Conversation*

## Slot D — "WHO IT'S FOR"
- **P4** (18 words)
  > For teachers, department heads, and administrators who want to think more deeply about their practice while teaching full-time.
- **P5** (19 words)
  > For educators ready to go deeper: toward doctoral study, school administration, or original scholarship in Christian education.

## Slot E — AT-A-GLANCE STATS (identical labels both pages)
...
2. **A capstone you shape** — a curriculum, a playbook, a podcast series, a workshop, or a journal article. *(17 words)*
3. **A foundation for doctoral study** — sustained original research under individualized faculty mentoring. *(12 words)*

## Slot G — URL
- **P4:** education.icscanada.edu/mwse · **P5:** education.icscanada.edu/mael

## Slot H — CROSSOVER BAND (purple-deep, full bleed, continuous across the fold)

**EYEBROW (P4 only; P5 carries it hidden to hold the slot):** Sample Courses
...
**HEADLINE** (6 words)
> Learn from Faculty Who *Walk Alongside* You
...
> Carolyn Bentum — Principal, Cairn Christian School · MA-EL student

*The unattributed "small cohort model" pull quote was cut — it competed with this, which proves the same point with a name on it.*
...
**EYEBROW**
> Cost, Aid & How to Apply

**HEADLINE** (4 words)
> An Investment *Within Reach*

## Money panel (reversed on purple)
...
*Leads with the per-course price, not the per-credit-hour rate — a skimmer who sees "$500" first anchors low and feels handled later.*
...
> Admission requires a four-year bachelor’s degree (or equivalent) with a B+ average, plus proficiency in English. Full requirements at education.icscanada.edu/admission.
...
Purple-deep full bleed, typographic, centred.
